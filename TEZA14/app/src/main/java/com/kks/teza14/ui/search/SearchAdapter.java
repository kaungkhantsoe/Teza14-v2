...
public class SearchAdapter extends BaseAdapter {
    ...
    public SearchAdapter(RequestManager requestManager) {
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bindPost(MemberModel model, int position) {
            ...
            if (memberPhotoArray.get(position) != null)
                requestManager.load(memberPhotoArray.get(model.getPosition()))
                        .into(ivUser);
            else
                requestManager.load(R.drawable.placeholder)
                        .into(ivUser);

            itemView.setOnClickListener(v -> context.startActivity(MemberDetailActivity.getMemberDetailActivity(context,model.getPosition())));
