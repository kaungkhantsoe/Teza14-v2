...
public class MyDateFormat {
    ...
    public SimpleDateFormat DATE_FORMAT_HM_A_D_MM_YYYY;
    public SimpleDateFormat DATE_POST;
    public SimpleDateFormat DATE_POST_TO_SHOW;
	...
	public MyDateFormat()
	{
        ...
        DATE_FORMAT_HM_A_D_MM_YYYY = new SimpleDateFormat("h:mm a dd MMM yyyy");
        DATE_POST_TO_SHOW = new SimpleDateFormat("MMM d, h:mm aaa");
        DATE_POST = new SimpleDateFormat("yyyyMMdd_HHmmss");
